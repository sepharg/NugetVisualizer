namespace UnitTests.IntegrationTests
{
    ...
    public class FileSystemRepositoryReaderTests : IntegrationTest
    {
        ...
        private void ThenAProjectForEachSolutionFileWithNugetIsReturned()
        {
            ...
            var oneProject = _projectIdentifiers.SingleOrDefault(x => x.SolutionName.Equals("MySol1"));
            ...
            _projectIdentifiers.SingleOrDefault(x => x.SolutionName.Equals("Sol2")).ShouldNotBeNull();
            _projectIdentifiers.SingleOrDefault(x => x.SolutionName.Equals("NoPackages")).ShouldNotBeNull();
            _projectIdentifiers.SingleOrDefault(x => x.SolutionName.Equals("RootSol")).ShouldNotBeNull();
        }
